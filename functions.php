...
function hexa_scripts() {
	...
	wp_enqueue_script( 'hexa-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );
...
function hexa_google_fonts() {
	...
	if ( 'off' !== _x( 'on', 'Source Sans Pro font: on or off', 'hexa' ) ) {
		...
		wp_register_style( 'hexa-source-sans-pro', "https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,700,300italic,400italic,700italic" );
...
function hexa_mce_css( $mce_css ) {
	...
	$font = "https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,700,300italic,400italic,700italic";
